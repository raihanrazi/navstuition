...
function chromaticfw_attr_sidebar( $attr, $context ) {
	...
	if ( !empty( $context ) ) {
		...
		$attr['aria-label'] = esc_attr( sprintf( _x( '%s Sidebar', 'sidebar aria label', 'chromaticfw' ), chromaticfw_get_sidebar_name( $context ) ) );
	}
...
function chromaticfw_attr_menu( $attr, $context ) {
	...
	if ( !empty( $context ) ) {
		...
		$attr['aria-label'] = esc_attr( sprintf( _x( '%s Menu', 'nav menu aria label', 'chromaticfw' ), chromaticfw_get_menu_location_name( $context ) ) );
	}
...
function chromaticfw_attr_entry_published( $attr ) {
	...
	$attr['title']    = get_the_time( _x( 'l, F j, Y, g:i a', 'post time format', 'chromaticfw' ) );
...
function chromaticfw_attr_comment_published( $attr ) {
	...
	$attr['title']    = get_comment_time( _x( 'l, F j, Y, g:i a', 'comment time format', 'chromaticfw' ) );
