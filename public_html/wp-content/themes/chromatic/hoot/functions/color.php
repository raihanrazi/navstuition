 ...
 * @return bool|string
 */
function chromaticfw_color_santize_hex( $hex, $validate_only = false ) {
	$hex = trim( $hex );
 ...
 */
function chromaticfw_color_lighten( $color, $intensity = 30 ) {
	return chromaticfw_color( $color, 'lighten', $intensity );
}
 ...
 * @return string Hexa Color
 */
function chromaticfw_color_darken( $color, $intensity = 30 ) {
	return chromaticfw_color( $color, 'darken', $intensity );
}
 ...
 * @return string Hexa Color
 */
function chromaticfw_color_increase( $color, $light_intensity = 30, $dark_intensity = '' ) {
	return chromaticfw_color( $color, 'increase', $light_intensity, $dark_intensity );
}
 ...
 * @return string Hexa Color
 */
function chromaticfw_color_decrease( $color, $dark_intensity = 30, $light_intensity = '' ) {
	return chromaticfw_color( $color, 'decrease', $dark_intensity, $light_intensity );
}
 ...
 * @return string Hexa Color
 */
function chromaticfw_color( $color, $operation, $intensity1, $intensity2 = 0 ) {
	static $chromaticfw_color = null; // cache

	if ( $chromaticfw_color === null ) {
		$chromaticfw_color = new _ChromaticFw_Color();
	}

	switch( $operation ) {
		case 'lighten' :
			$color = $chromaticfw_color->lighten( $color, $intensity1 );
			break;
		case 'darken' :
			$color = $chromaticfw_color->darken( $color, $intensity1 );
			break;
		case 'increase' :
			$intensity2 = ( empty( $intensity2 ) ) ? $intensity1 : $intensity2;
			$color = $chromaticfw_color->increase( $color, $intensity1, $intensity2 );
			break;
		case 'decrease' :
			$intensity2 = ( empty( $intensity2 ) ) ? $intensity1 : $intensity2;
			$color = $chromaticfw_color->decrease( $color, $intensity1, $intensity2 );
			break;
	}
...
class _ChromaticFw_Color {
	...
	public function lighten( $hex, $intensity ) {
		$hex = chromaticfw_color_santize_hex( $hex ); // Returns sanitized color with '#'
		if ( empty( $hex ) )
			return null;
	...
	// 	$color = chromaticfw_color_lighten( '000', 100 );
	// 	var_dump( '000 ' . $color);
	// 	$color = chromaticfw_color_darken( 'fff', 100 );
	// 	var_dump( 'fff ' . $color);
	// 	$color = chromaticfw_color_lighten( '000', 0 );
	// 	var_dump( '000 ' . $color);
	// 	$color = chromaticfw_color_darken( 'fff', 0 );
	// 	var_dump( 'fff ' . $color);
	// 	$color = chromaticfw_color_lighten( '000', 200 );
	// 	var_dump( '000 ' . $color);
	// 	$color = chromaticfw_color_darken( 'fff', 200 );
	// 	var_dump( 'fff ' . $color);
	// 	$color = chromaticfw_color_increase( '#000' );
	// 	var_dump( '000 ' . $color);
	// 	$color = chromaticfw_color_increase( '#fff' );
	// 	var_dump( 'fff ' . $color);
	// 	$color = chromaticfw_color_decrease( '#000' );
	// 	var_dump( '000 ' . $color);
	// 	$color = chromaticfw_color_decrease( '#fff' );
	// 	var_dump( 'fff ' . $color);
	// }
