...
add_filter( 'excerpt_more', 'chromaticfw_excerpt_more', 5 );

/* Modifies the arguments and output of wp_link_pages(). */
add_filter( 'wp_link_pages_args', 'chromaticfw_link_pages_args', 5 );
add_filter( 'wp_link_pages_link', 'chromaticfw_link_pages_link', 5 );

/* Filters to add microdata support to common template tags. */
add_filter( 'the_author_posts_link',          'chromaticfw_the_author_posts_link',          5 );
add_filter( 'get_comment_author_link',        'chromaticfw_get_comment_author_link',        5 );
add_filter( 'get_comment_author_url_link',    'chromaticfw_get_comment_author_url_link',    5 );
add_filter( 'comment_reply_link',             'chromaticfw_comment_reply_link_filter',      5 );
add_filter( 'get_avatar',                     'chromaticfw_get_avatar',                     5 );
add_filter( 'post_thumbnail_html',            'chromaticfw_post_thumbnail_html',            5 );
add_filter( 'comments_popup_link_attributes', 'chromaticfw_comments_popup_link_attributes', 5 );
 ...
 * @return string
 */
function chromaticfw_excerpt_more( $text ) {
 ...
 * @return array
 */
function chromaticfw_link_pages_args( $args ) {
 ...
 * @return string
 */
function chromaticfw_link_pages_link( $link ) {
 ...
 * @return string
 */
function chromaticfw_the_author_posts_link( $link ) {
 ...
 * @return string
 */
function chromaticfw_get_comment_author_link( $link ) {
 ...
 * @return string
 */
function chromaticfw_get_comment_author_url_link( $link ) {
 ...
 * @return string
 */
function chromaticfw_comment_reply_link_filter( $link ) {
 ...
 * @return string
 */
function chromaticfw_get_avatar( $avatar ) {
 ...
 * @return string
 */
function chromaticfw_post_thumbnail_html( $html ) {
 ...
 * @return string
 */
function chromaticfw_comments_popup_link_attributes( $attr ) {
