...
*/
            ...
            $this->sections[] = array(
                ...
                'fields' => array(  
                    ...
                    array(
                        ...
                        'title'     => __('FlatOn Pro Options. <a href="http://www.webulous.in/?add-to-cart=23">Upgrade Now</a> for just $29.', 'flaton'),
                        'desc'      => __('These options are available only in FlatOn Pro version theme. Upgrade now for just $29.', 'flaton')
                    ),
                    array(
                        'id'=>'pagenavi',
                        'type' => 'switch', 
            ...
            $this->sections[] = array(
                ...
                'fields' => array(  
                    ...
                    array(
                        ...
                        'default' => __( 'Powered by <a href="http://wordpress.org/" target="_blank">WordPress</a>. Theme by <a href="http://www.webulous.in/">Webulous</a>.', 'flaton' ),
                        'validate' => 'html',
                        ),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'desc'      => __('Please refer to documentation page of this site\'s demo to know how to use theme options specific to this theme. For professional support about customization and other advices from theme author, Please <a href="http://www.webulous.in/?add-to-cart=23">Upgrade</a> to FlatOn Pro Version', 'flaton')
                    ),
                )
            );
        ...
        public function setArguments() {
            ...
            if (!isset($this->args['global_variable']) || $this->args['global_variable'] !== false) {
                ...
                $this->args['intro_text'] = sprintf(__('<p class="btn-upgrade"><a href="http://www.webulous.in/?add-to-cart=23"><i class="fa fa-upload"></i> Upgrade for just $29</a> <a href="http://demo.webulous.in/flaton" class="vide-demo"><i class="fa fa-eye"></i>View Demo</p>', 'redux-framework-demo'), $v);
            } else {
