...
<article class="kingdom-entry-content">
	...
	if ( wp_attachment_is_image( $post->ID ) ) { ?>
		...
		<?php the_excerpt(); ?>
		<small class="kingdom-top-link"><a href="<?php echo get_permalink( $post->post_parent ); ?>"><?php _e( '[Back to the Gallery]', 'kingdom' ); ?></a></small>
	<?php } else {
		the_content();
	} ?>
...
<div class="kingdom-entry-utility"><span class="tag-links"><?php echo the_tags( '' ); ?></span></div>
