	...
	<div id="articles" class="articles" role="main">
		...
		<section class="post meta-title">
			<div class="kingdom-entry-body">
				<h2 class="kingdom-entry-title"><?php printf( __( 'Tag Archives: %s', 'kingdom' ), '<span>' . single_tag_title( '', false ) . '</span>' ); ?></h2>
				<?php if ( tag_description() ) { /* Show an optional tag description */ ?>
					<article class="kingdom-entry-content"><?php echo tag_description(); ?></article>
				<?php } ?>
