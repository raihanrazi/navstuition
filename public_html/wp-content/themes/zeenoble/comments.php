...
if ( post_password_required()) : ?>
	<p><?php _e('Enter password to view comments.', 'zeeNoble_language'); ?></p>
<?php return; endif; ?>
...
<?php if ( have_comments() ) : ?>
	...
	<h3 class="comments-title"><?php comments_number( '', __('One comment','zeeNoble_language'), __('% comments','zeeNoble_language') );?></h3>
