...
?>
	...
	<div class="wrap themezee-admin-wrapper">  			
		...
		<div id="themezee-admin-header" class="themezee-admin-clearfix">
			...
			<h2 class="themezee-admin-header-title"><?php echo $theme_data->Name; ?> <?php _e('Theme Options', 'zeeNoble_language'); ?></h2>
		...
		<div id="themezee-admin-wrap" class="themezee-admin-clearfix">
			...
			<?php if ( isset( $_GET['settings-updated'] ) ) : ?>
				<div class="themezee-updated"><?php _e('Theme Options successfully updated.', 'zeeNoble_language'); ?></div>
			<?php endif; ?>
...
function themezee_options_display_setting( $setting = array() ) {
	...
	switch ( $setting['type'] ) {
		...
		case 'htmltext':
			echo "<textarea id='".$setting['id']."' name='zeenoble_options[".$setting['id']."]' rows='1'>" . wp_kses_post($options[$setting['id']]) . "</textarea>";
			echo '<br/><label>'.$setting['desc'].'</label>';
		break;
